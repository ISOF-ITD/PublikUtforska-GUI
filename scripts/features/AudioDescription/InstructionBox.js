  ...
  return (
    <div>
      ...
      <button type="button"
        ...
        className="ml-4 mt-2 text-link underline cursor-pointer inline-block text-sm"
      >
      ...
      {isOpen && (
        <div className="ml-4 mt-2 text-muted leading-relaxed space-y-2 whitespace-pre-line text-sm">
          {details}
        </div>
      )}
    </div>
...
const InstructionBox = () => {
  return (
    <div className="bg-isof/5 p-4 rounded-lg mb-6 border border-isof/20 text-body">
      <details className="group">
        ...
        <summary className="flex items-center cursor-pointer list-none mb-1">
          ...
          />
          <span className="text-link font-semibold text-base">
        ...
        <div className="mt-4 space-y-4 text-sm">
          {/* Steps container */}
          <div className="bg-surface p-4 rounded-lg border border-border shadow-sm space-y-6 text-body">
            {/* Render each step */}
          ...
          {/* Quick example table */}
          <div className="bg-surface p-4 rounded-lg border border-border shadow-sm text-body">
            <p className="font-semibold mb-2 text-link">
            ...
            <table className="w-full table-auto border-collapse text-xs mb-2">
              ...
              <tbody>
                {/* Good example row */}
                <tr className="odd:bg-surface even:bg-surface-muted border-b border-border">
                  <td className="py-3 px-4 font-mono">00:00</td>
                  <td className="py-3 px-4 text-link font-semibold">
          ...
          {/* Fuller examples */}
          <div className="bg-surface p-4 rounded-lg shadow-sm border border-border text-body">
            <details>
