export default function TranscriptionInstructions() {
  return (
    <div className="helptext">
      ...
      <p>
        ...
        <br />
        <br />
        I de fall uppteckningen består av en sida med bara text, till
      ...
      <p>
        ...
        <code>***</code>
        {' '}
        i stället för ordet ifråga. Bocka också i ”Innehåller
      ...
      <p>
        ...
        <code>###</code>
        {' '}
        för varje ord. Bocka också i ”Sidan
