...
export function TermNode({ node, selectedTags, onToggle, source }) {
  ...
  return (
    <div className="text-sm"> {/* Smaller text for more compact UI */}
      <div className="flex items-center py-1"> {/* Minimal vertical padding */}
        ...
        {/* Label + checkbox */}
        <label
          className={`cursor-pointer flex items-center gap-2 px-1 rounded 
            ${isSelected ? "bg-isof text-white" : "hover:bg-gray-50"}`}
        >
          <input
            type="checkbox"
            checked={isSelected}
