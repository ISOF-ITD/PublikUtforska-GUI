...
#find www -name '*.js' | xargs grep -l 'https://garm.isof.se/folkeservice/' | xargs sed -i.bak 's|https://garm.isof.se/folkeservice/|http://localhost:8000/|g'
#find www -name '*.js' | xargs grep -l 'https://ull-test.isof.se/folkeservice/' | xargs sed -i.bak 's/https:\/\/ull-test.isof.se\/folkeservice/https:\/\/garm.isof.se\/folkeservice/g'
#find www -name '*.js' | xargs grep -l 'https://ull-test.isof.se/folkeservice/' | xargs sed -i.bak 's|https://ull-test.isof.se/folkeservice/|https:\/\/garm.isof.se\/folkeservice|g'
